...
discussions](https://github.com/davep/ng2nlm/discussions). If it seems like
something that makes sense for ng2nlm I'll turn it into an issue from there.

Be sure to [have a look over the TODO
issues](https://github.com/davep/ng2nlm/issues?q=is%3Aissue+is%3Aopen+label%3ATODO)
...
issue](https://github.com/davep/ng2nlm/issues). When doing so, please
provide as much detail as possible, include things like ng2nlm version,
...
- Check merged/closed or open pull requests to ensure you're not duplicating
  effort.
- Check previous [discussions](https://github.com/davep/ng2nlm/discussions)
  to see if the change you're making has been discussed before, or is under
  discussion at the moment.
- Check closed and open [issues](https://github.com/davep/ng2nlm/issues) to
  see if the change you're making has been discussed before, or is under
  discussion at the moment.
- For any non-trivial PR I'd suggest starting a
  [discussion](https://github.com/davep/ng2nlm/discussions) first to propose
